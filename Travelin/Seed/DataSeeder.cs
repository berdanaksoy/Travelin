...
namespace Travelin.Seed
{
    public class DataSeeder
    {
        ...
        private async Task<List<Category>> SeedCategoriesAsync()
        {
            ...
            {
                new Category { CategoryName = "Kültür Turları", IconUrl = "https://cdn-icons-png.flaticon.com/512/5389/5389807.png", IsStatus = true },
                new Category { CategoryName = "Doğa ve Kamp", IconUrl = "https://cdn-icons-png.flaticon.com/512/8048/8048967.png", IsStatus = true },
                new Category { CategoryName = "Deniz ve Kum", IconUrl = "https://cdn-icons-png.flaticon.com/512/7894/7894015.png", IsStatus = true },
                new Category { CategoryName = "Şehir Turları", IconUrl = "https://cdn-icons-png.magnific.com/256/17359/17359653.png?semt=ais_white_label", IsStatus = true },
        ...
        private async Task<List<Tour>> SeedToursAsync(List<Category> categories)
        {
            ...
            var tours = new List<Tour>
            {
                ...
                new Tour { Title = "Barselona Kültür ve Gaudí Turu", Country = "İspanya", City = "Barselona", Description = "Sagrada Familia, Park Güell ve Gaudí'nin eşsiz mimarisiyle Barselona'nın kültürel dokusunu keşfedin. Gotik Mahalle'de tarih, Las Ramblas'ta yaşam.", Capacity = 25, TourDate = now.AddDays(45), DayNight = "4 Gün / 3 Gece", ImageUrl = "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=800", Price = 17000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[0].CategoryId, VideoUrl = "" },
                new Tour { Title = "Roma Antik Şehir Turu", Country = "İtalya", City = "Roma", Description = "Kolezyum, Roma Forumu ve Vatikan ile antik dünyanın kalbine yolculuk. Trevi Çeşmesi'ne bozuk para atmayı unutmayın.", Capacity = 30, TourDate = now.AddDays(60), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=800", Price = 19500, LocationImageUrl = "", IsStatus = true, CategoryId = categories[0].CategoryId, VideoUrl = "" },
                new Tour { Title = "Atina Mitoloji ve Akropolis Turu", Country = "Yunanistan", City = "Atina", Description = "Partenon, Akropolis ve antik Yunan medeniyetinin izleri. Plaka bölgesinde geleneksel taverna deneyimi.", Capacity = 28, TourDate = now.AddDays(38), DayNight = "4 Gün / 3 Gece", ImageUrl = "https://images.unsplash.com/photo-1555993539-1732b0258235?w=800", Price = 15500, LocationImageUrl = "", IsStatus = true, CategoryId = categories[0].CategoryId, VideoUrl = "" },
                new Tour { Title = "Kahire Piramitler ve Firavunlar Turu", Country = "Mısır", City = "Kahire", Description = "Giza Piramitleri, Sfenks ve Mısır Müzesi. Nil Nehri'nde tekne turu ve antik firavun tarihine yolculuk.", Capacity = 22, TourDate = now.AddDays(52), DayNight = "6 Gün / 5 Gece", ImageUrl = "https://images.unsplash.com/photo-1539768942893-daf53e448371?w=800", Price = 21000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[0].CategoryId, VideoUrl = "" },
                new Tour { Title = "Kudüs Kutsal Topraklar Turu", Country = "İsrail", City = "Kudüs", Description = "Üç semavi dinin buluştuğu kutsal şehir. Ağlama Duvarı, Kutsal Kabir Kilisesi ve tarihi eski şehir.", Capacity = 20, TourDate = now.AddDays(70), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://turkmaarifansiklopedisi.org.tr/uploads/matter/original/kudus-1677d0a88dca45.webp", Price = 18000, LocationImageUrl = "", IsStatus = false, CategoryId = categories[0].CategoryId, VideoUrl = "" },

                // DOĞA VE KAMP (categories[1])
                new Tour { Title = "Kapadokya Balon ve Vadi Turu", Country = "Türkiye", City = "Nevşehir", Description = "Peri bacaları, sıcak hava balonu ve yeraltı şehirleri. Güneşin doğuşunu gökyüzünden izleyin.", Capacity = 24, TourDate = now.AddDays(30), DayNight = "3 Gün / 2 Gece", ImageUrl = "https://blog.obilet.com/wp-content/uploads/2018/10/kapadokya.jpg", Price = 9500, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ERvMOD.jpg", IsStatus = true, CategoryId = categories[1].CategoryId, VideoUrl = "https://www.youtube.com/embed/pE6-00TAakM?controls=1&rel=0" },
                new Tour { Title = "İsviçre Alpleri Kamp Turu", Country = "İsviçre", City = "Interlaken", Description = "Alp dağları, buzul gölleri ve nefes kesen manzaralar. Doğayla iç içe kamp deneyimi ve yürüyüş parkurları.", Capacity = 16, TourDate = now.AddDays(85), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://www.avruparuyasi.blog/userfiles/mont-blanc-da%C4%9F%C4%B1-isvi%C3%A7re.jpg", Price = 24000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ER2oEZ.jpg", IsStatus = true, CategoryId = categories[1].CategoryId, VideoUrl = "https://www.youtube.com/embed/AMqAZ5Iyhpo?controls=1&rel=0" },
                ...
                new Tour { Title = "İzlanda Şelaleler ve Kuzey Işıkları", Country = "İzlanda", City = "Reykjavik", Description = "Buz mağaraları, gayzerler ve büyülü kuzey ışıkları. Doğanın en vahşi ve güzel halini yaşayın.", Capacity = 18, TourDate = now.AddDays(95), DayNight = "6 Gün / 5 Gece", ImageUrl = "https://wp.oggusto.com/wp-content/uploads/2025/02/izlanda-seyahat-rehberi.webp", Price = 28000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ERzAlI.jpg", IsStatus = true, CategoryId = categories[1].CategoryId, VideoUrl = "" },
                new Tour { Title = "Amazon Yağmur Ormanı Keşfi", Country = "Brezilya", City = "Manaus", Description = "Dünyanın akciğerleri Amazon'da nehir safarisi, egzotik canlılar ve yerli kabile kültürü.", Capacity = 14, TourDate = now.AddDays(110), DayNight = "7 Gün / 6 Gece", ImageUrl = "https://tzv.org.tr/wp-content/uploads/2023/09/Dunyadaki-En-Buyuleyici-Orman-Amazon-Yagmur-Ormanlari11.jpeg", Price = 32000, LocationImageUrl = "", IsStatus = false, CategoryId = categories[1].CategoryId, VideoUrl = "https://www.youtube.com/embed/QvfMRTWuLZw?controls=1&rel=0" },

                // DENİZ VE KUM (categories[2])
                new Tour { Title = "Maldivler Cennet Adaları", Country = "Maldivler", City = "Male", Description = "Turkuaz sular, beyaz kum plajları ve su üstü bungalovlar. Dalış ve şnorkel ile mercan resiflerini keşfedin.", Capacity = 16, TourDate = now.AddDays(75), DayNight = "6 Gün / 5 Gece", ImageUrl = "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=800", Price = 35000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "" },
                new Tour { Title = "Antalya Tekne ve Koy Turu", Country = "Türkiye", City = "Antalya", Description = "Akdeniz'in saklı koyları, mavi yolculuk ve tarihi Kaleiçi. Güneş, deniz ve tarih bir arada.", Capacity = 30, TourDate = now.AddDays(35), DayNight = "4 Gün / 3 Gece", ImageUrl = "https://images.unsplash.com/photo-1590523278191-995cbcda646b?w=800", Price = 8500, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ER2iMF.jpg", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "https://www.youtube.com/embed/9G6Cs3ebAcs?controls=1&rel=0" },
                new Tour { Title = "Bali Tropik Ada Turu", Country = "Endonezya", City = "Bali", Description = "Pirinç terasları, tapınaklar ve muhteşem plajlar. Ubud'da ruhani huzur, Kuta'da sörf keyfi.", Capacity = 22, TourDate = now.AddDays(88), DayNight = "7 Gün / 6 Gece", ImageUrl = "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800", Price = 26000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ER2X3Q.jpg", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "https://www.youtube.com/embed/LCqK7wZd2Pk?controls=1&rel=0" },
                new Tour { Title = "Bodrum Mavi Yolculuk", Country = "Türkiye", City = "Muğla", Description = "Ege'nin berrak sularında yelkenli ile koydan koya. Gece yıldızlar altında tekne konaklaması.", Capacity = 12, TourDate = now.AddDays(48), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://media.cntravellerme.com/photos/6a4cc5a913195f83ca79d318/16:9/w_2560%2Cc_limit/2212083738", Price = 12000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "" },
                new Tour { Title = "Karayipler Kruvaziyer Turu", Country = "Bahamalar", City = "Nassau", Description = "Lüks kruvaziyer ile Karayip adaları. Beyaz plajlar, palmiyeler ve tropik cennet.", Capacity = 40, TourDate = now.AddDays(120), DayNight = "8 Gün / 7 Gece", ImageUrl = "https://assets.dream.clubmed/pm_7531_639_639228-g2xhddok04-swhr.jpg", Price = 38000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "" },

                // ŞEHİR TURLARI (categories[3])
                new Tour { Title = "Paris Işık Şehri Turu", Country = "Fransa", City = "Paris", Description = "Eyfel Kulesi, Louvre ve Şanzelize. Aşk şehrinde romantik bir kaçamak ve sanat dolu günler.", Capacity = 28, TourDate = now.AddDays(40), DayNight = "4 Gün / 3 Gece", ImageUrl = "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800", Price = 20000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[3].CategoryId, VideoUrl = "" },
                ...
                new Tour { Title = "Tokyo Geleneksel ve Modern", Country = "Japonya", City = "Tokyo", Description = "Tapınaklar, gökdelenler ve kiraz çiçekleri. Geleneğin ve teknolojinin buluştuğu büyüleyici şehir.", Capacity = 24, TourDate = now.AddDays(115), DayNight = "7 Gün / 6 Gece", ImageUrl = "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=800", Price = 33000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ERzYjL.jpg", IsStatus = true, CategoryId = categories[3].CategoryId, VideoUrl = "https://www.youtube.com/embed/O2yMv1JDYRU?controls=1&rel=0" },

                // KIŞ TURLARI (categories[4])
                new Tour { Title = "Uludağ Kayak Turu", Country = "Türkiye", City = "Bursa", Description = "Karlı pistler, kayak keyfi ve dağ manzarası. Kış sporları ve sıcak şömine başı.", Capacity = 26, TourDate = now.AddDays(-15), DayNight = "3 Gün / 2 Gece", ImageUrl = "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=800", Price = 8000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ERvbZh.jpg", IsStatus = true, CategoryId = categories[4].CategoryId, VideoUrl = "https://www.youtube.com/embed/NayI2PKvTlw?controls=1&rel=0" },
                new Tour { Title = "Alpler Kayak Merkezi Turu", Country = "Avusturya", City = "Innsbruck", Description = "Dünya çapında kayak pistleri, Alp köyleri ve kış masalı. Profesyonel kayak deneyimi.", Capacity = 20, TourDate = now.AddDays(-30), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://images.unsplash.com/photo-1491555103944-7c647fd857e6?w=800", Price = 25000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[4].CategoryId, VideoUrl = "" },
                ...
                new Tour { Title = "İtalya Gastronomi Turu", Country = "İtalya", City = "Bologna", Description = "Gerçek İtalyan mutfağı, şarap tadımı ve makarna atölyesi. Lezzetin başkentinde damak şöleni.", Capacity = 18, TourDate = now.AddDays(58), DayNight = "5 Gün / 4 Gece", ImageUrl = "https://images.unsplash.com/photo-1498579150354-977475b7ea0b?w=800", Price = 21000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[5].CategoryId, VideoUrl = "" },
                new Tour { Title = "Gaziantep Lezzet Turu", Country = "Türkiye", City = "Gaziantep", Description = "Baklava, kebap ve zengin Antep mutfağı. UNESCO gastronomi şehrinde eşsiz tatlar.", Capacity = 25, TourDate = now.AddDays(33), DayNight = "3 Gün / 2 Gece", ImageUrl = "https://images.unsplash.com/photo-1601050690597-df0568f70950?w=800", Price = 6500, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ER2Ahh.jpg", IsStatus = true, CategoryId = categories[5].CategoryId, VideoUrl = "https://www.youtube.com/embed/11Y1_YlLnz8?controls=1&rel=0" },
                ...
                // Ek karışık turlar
                new Tour { Title = "Santorini Gün Batımı Turu", Country = "Yunanistan", City = "Santorini", Description = "Beyaz badanalı evler, mavi kubbeler ve dünyanın en güzel gün batımı. Ege'nin incisi.", Capacity = 20, TourDate = now.AddDays(62), DayNight = "4 Gün / 3 Gece", ImageUrl = "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800", Price = 19000, LocationImageUrl = "", IsStatus = true, CategoryId = categories[2].CategoryId, VideoUrl = "" },
                new Tour { Title = "İstanbul Tarihi Yarımada Turu", Country = "Türkiye", City = "İstanbul", Description = "Ayasofya, Topkapı Sarayı ve Kapalıçarşı. İki kıtayı birleştiren şehrin binlerce yıllık tarihi.", Capacity = 35, TourDate = now.AddDays(28), DayNight = "3 Gün / 2 Gece", ImageUrl = "https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=800", Price = 7000, LocationImageUrl = "https://resmim.net/cdn/2026/08/18/ERvXAx.jpg", IsStatus = true, CategoryId = categories[0].CategoryId, VideoUrl = "https://www.youtube.com/embed/eV6lTEY95yY?controls=1&rel=0" }
            };
